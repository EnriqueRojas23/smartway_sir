...
namespace Data.Common.DbConnectionFactories
{
    ...
    public class DefaultConnectionFactory : IDbConnectionFactory
    {
        ...
        public static string DefaultConnectionString
        {
            get
            {
                return ConfigurationManager.ConnectionStrings["SmartwaySeg"].ConnectionString;
            }
        }

        public static string ERPOfilogiConnectionString
        {
            get
            {
                return ConfigurationManager.ConnectionStrings["CnnERP_Ofilogi"].ConnectionString;
            }
        }

        public static string ERPOfiloventConnectionString
        {
            get
            {
                return ConfigurationManager.ConnectionStrings["CnnERP_Ofivent"].ConnectionString;
            }
        }

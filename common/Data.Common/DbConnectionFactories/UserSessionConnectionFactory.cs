...
namespace Data.Common.DbConnectionFactories
{
    ...
    public class UserSessionConnectionFactory : IDbConnectionFactory
    {
        ...
        public static string UserERPOfilogiSessionConnectionString
        {
            get { return DefaultConnectionFactory.ERPOfilogiConnectionString; }
        }

        public static string UserERPOfiventSessionConnectionString
        {
            get { return DefaultConnectionFactory.ERPOfiloventConnectionString; }
        }

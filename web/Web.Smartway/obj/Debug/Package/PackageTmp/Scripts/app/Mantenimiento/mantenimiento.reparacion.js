...
const $grilla = $("#gridreparacion");
const $pagergrilla = $("#gridreparacionpager");
...
function configurarGrilla()
{
    ...
    $grilla.jqGrid({
        ...
        datatype: 'json',
        mtype: 'Get',
        colNames: ['',  'Código Smartway','Nivel Reparación','Reparación', 'Categoría Reparación', 'Acciones'],
        colModel:
        [
             { key: true, hidden: true, name: 'idreparacion', index: 'idreparacion' ,classes:"grid-col"},
             { key: false, hidden: false, editable: true ,name: 'codigosmartway'
             , index: 'codigosmartway', width: '30px', align: 'left'
             , classes:"grid-col",formatter: formatedit
             },
                     { 
                 key: false, hidden: false, editable: true ,name: 'nivelreparacion'
                , index: 'nivelreparacion', width: '90px', align: 'left'
                , classes:"grid-col",formatter: formatedit
                , edittype: "select"
             ...
             { key :false , hidden:false, editable: true , name :'descripcion' 
               , index : 'descripcion', width: '180px', formatter: formatedit , classes:"grid-col"
             },
      
            { key: false, hidden: false, editable: true ,name: 'categoriareparacion'
                    , index: 'categoriareparacion', width: '60px',editrules: { required: true}, align: 'center'
                    , classes:"grid-col",formatter: formatedit
                    , edittype: "select"
                    , editoptions: { dataUrl: fcnUrlControlGrid('categoriareparacion')}
            },
                { key: false, hidden: false, editable: false, name: 'idreparacion', width: '40', index: 'idreparacion' ,  formatter:  displayButtons,classes:"grid-col"}
        ],
        pager: $pagergrilla,
        rowNum: 40,

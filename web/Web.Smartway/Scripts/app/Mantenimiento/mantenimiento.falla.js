...
const $grilla = $("#gridfalla");
const $pagergrilla = $("#gridfallapager");
...
function reload()
{
    var idcat =  $('#idcategoriafalla').val()
...
function configurarGrilla()
{
    ...
    $grilla.jqGrid({
        ...
        datatype: 'json',
        mtype: 'Get',
        colNames: ['', 'Categoría Falla','Tipo Falla', 'Tipo Producto' ,'Fabricante', 'Código Smartway', 'Falla','Acciones'],
        colModel:
        [
            { key: true, hidden: true, name: 'idfalla', index: 'idfalla' ,classes:"grid-col"},
            { key: false, hidden: false, editable: true ,name: 'categoriafalla'
                    , index: 'categoriafalla', width: '190px',editrules: { required: true}, align: 'center'
                    , classes:"grid-col",formatter: formatedit
                    , edittype: "select"
                    , editoptions: { dataUrl: fcnUrlControlGrid('categoriafalla')}
            },
             { key: false, hidden: false, editable: true ,name: 'tipofalla'
                    , index: 'tipofalla', width: '140px', align: 'left'
                    , classes:"grid-col",formatter: formatedit
                    , edittype: "select"
                    , editoptions: { dataUrl: fcnUrlControlGrid('tipofalla')}
            },
            ...
            { key: false, hidden: false, editable: true ,name: 'fabricante'
             ...
             { key :false , hidden:false, editable: true , name :'descripcion' 
               , index : 'descripcion', formatter: formatedit , classes:"grid-col"
             },

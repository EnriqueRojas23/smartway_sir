...
const URL_guardarIngreso = UrlHelper.Action("guardarIngreso","Inventario","Inventario")
...
function OnCompleteTransaction(xhr, status)
{
    ...
    {
        sweetAlert("No se realizó la carga", jsonres.msj , "error");
...
function configurarGrilla()
{
    ...
    $grilla.jqGrid({
        ...
        datatype: 'json',
        mtype: 'POST',
        colNames: ['','SKU' , 'Modelo' ,'Serie','IMEI', 'MAC', 'Cantidad'  ],
        colModel:
        [
            { key: true, hidden: true, name: 'item', align: 'center' },
            { key: false, name: 'codigo',  align: 'center',  sortable: false,  formatter: formatedit  },
            { key: false, name: 'modelo',  align: 'center', sortable: false, formatter: formatedit },
            ...
            { key: false, name: 'cantidad',  align: 'center',  sortable: false,  formatter: formatedit  },
            //{ key: false, hidden: false, editable: false ,name: 'idfila', width:'40' , index: 'idfila' ,  formatter:  displayButtons,classes:"grid-col"}

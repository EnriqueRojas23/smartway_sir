...
const URL_guardarIngreso = UrlHelper.Action("guardarIngreso","Recepcion","Recepcion")
const URL_subirarchivo = UrlHelper.Action("SubirArchivo","Recepcion", "Recepcion")
...
function configurarGrilla()
{
    ...
    $grilla.jqGrid({
        ...
        datatype: 'json',
        mtype: 'POST',
        colNames: ['', 'Item' ,'SKU','Serie', 'IMEI', 'MAC' , 'Pallet' ,'Fabricante' ],
        colModel:
        [

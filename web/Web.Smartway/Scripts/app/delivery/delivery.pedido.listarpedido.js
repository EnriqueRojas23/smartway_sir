...
function configurarGrilla() {
    ...
    $(grilla).jqGrid({
        ...
        [
            ...
            { key: false, hidden: false, name: 'ped_int_id', index: 'ped_int_id', width: '80', align: 'center', formatter: editarPedido },
            { key: false, hidden: false, name: 'ped_int_id', index: 'ped_int_id', width: '80', align: 'center', formatter: verDetallePedido },
            ...
            { key: false, hidden: false, name: 'ped_dat_fechapedido',    index: 'ped_dat_fechapedido',    width: '170', align: 'center' },
...
function verDetallePedido(cellvalue, options, rowObject) {
    ...
    var control = $("<a></a>");
    control.append("Ver Detalle")
    control.attr("id", "lnk" + cellvalue);
    control.attr("href", "javascript:IrDetallePedido('" + cellvalue + "')");

    var htmlcontrol = control[0].outerHTML;
    return htmlcontrol
}

function IrDetallePedido(id){

    if (id == undefined) {
        alert(MENSAJES.getError("IrDetallePedido", "err_nullarg"));
        return;
    }
...
function editarPedido(cellvalue, options, rowObject) {
    var control = '<a href="javascript:irEditar(' + cellvalue + ')">Editar</a>';
    return control;
}
